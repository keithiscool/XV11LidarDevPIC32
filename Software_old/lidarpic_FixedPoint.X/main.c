...
void main(void){
    ...
    while( (timeFlagFiveSec != true) && (enoughAngles == false) ) {
...
void _general_exception_handler(void) {
    ...
    while (1)
    {
        LATBbits.LATB9 = 1;    //toggle off LED 2
        LATBbits.LATB10 = 1;    //toggle off LED 2
        LATBbits.LATB11 = 1;    //toggle off LED 2
        LATBbits.LATB12 = 0;    //toggle off LED 2
        LATBbits.LATB13 = 1;    //toggle off LED 2
