...
#define TICK_MILLI_SECOND                       TICK_SECOND/100

#define MODEM_TIMEOUT_TICK                      TICK_MILLI_SECOND * MODEM_TIMEOUT_COUNT

#define HART_TIMEOUT_TIME                       TICK_SECOND * 5
#define HART_DLY_TIME                           TICK_SECOND * 5
